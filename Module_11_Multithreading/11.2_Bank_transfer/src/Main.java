...
public class Main {
    ...
    private static Integer ACCOUNTS_QUANTITY = 3; //количество сгенерированных аккаунтов
    private static Integer TRANSFERS_QUANTITY = 100_000; //кол-во транзакций каждого потока
