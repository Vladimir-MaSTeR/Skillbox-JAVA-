...
public class RoadCamera
{
    ...
    {
        //Параметры программы
        int maxOncomingSpeed = 60; // km/h скорость с которой можно ехать
        int speedFineGrade = 20; // km/h  шаг скорости после которого штраф увеличивается на
        int finePerGrade = 500 * 2; // RUB
        int criminalSpeed = 180; // km/h скорость после которой вызывать полицию
